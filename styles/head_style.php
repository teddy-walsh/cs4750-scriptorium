            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                          <?php 
                                if(!isset($_SESSION["id"]) || $_SESSION["id"] == -1){ // if the user is not logged in, show the two buttons
                                    echo '<a href="?command=login" class="btn btn-outline-light me-2" role="button">Login</a>
                                        <a href="?command=account-create" class="btn btn-warning" role="button">Sign-up</a>';
                                    } else {
                                    echo '<a href="?command=logout" class="btn btn-danger" role="button">Logout</a>';
                                }
                            ?>
                        </li>
                    </ul>
